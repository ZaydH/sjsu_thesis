...
\begin{frame}{Mixed-Bag Solver}{Final Seed Piece Selection Stage}
    \onslide<1->{
    ...
    \onslide<2->{    
      \begin{block}{\textbf{Mixed-Bag Solver}} 
        ...
        \begin{itemize}
          ...
          \vspace{0.6em}     
          \item \textbf{Summary}: A single seed piece is selected from each segment cluster.
          \vspace{0.4em}
          \begin{itemize}
            \item A seed piece is ``distinctive'' as defined by Paikin~\& Tal
          \end{itemize}
        \end{itemize}
      \end{block}
    }
...
\begin{frame}{Mixed-Bag Solver}{Final Assembly Stage}
  \begin{itemize}
