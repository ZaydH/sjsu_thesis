...
\setbeamercolor{subsection in toc}{use=normal text,fg=normal text.fg} 
...
\begin{frame}{Mixed-Bag Solver}{Basic Structure}
  \begin{center}
    \fbox{\includegraphics[width=0.95\textwidth]{./images/cropped_algorithm_structure_overview.pdf}}
    \vfill    
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%
...
\begin{frame}{Mixed-Bag Solver}{Overview}
  ...
  \end{itemize}
  \begin{center}
    \fbox{\includegraphics[width=0.96\textwidth]{./images/cropped_algorithm_structure_overview.pdf}}
    \vfill    
  \end{center}
\end{frame}
%%%%%%%%%%%%%%%%
  ...
  \begin{center}
	  \begin{tabular}{ 
	    >{\centering\arraybackslash}m{0.8\textwidth}}
		    \fbox{\includegraphics[scale=0.125]{./images/segmentation/pomeranz_805_8.jpg}}
		    \\[-0.2em]~\\[-0.2em]
		    Image~(a) \textendash { }805~Pieces~\cite{pomeranzBenchmarkImages}
	      \\~\\[-0.2em]
		    \fbox{\includegraphics[scale=0.125]{./images/segmentation/mcgill_540_20.jpg}}
	      \\[-0.2em]~\\[-0.2em]
		...
		\begin{center}  
		  \vspace{-2em}
			\begin{equation} \label{eq:segmentOverlap}
			  Overlap_{\Phi_i,\Phi_j} = \max\limits_{\zeta_x \in \Phi_i} {\frac{|MA_{\zeta_x} \bigcap \Phi_j|}{\text{min}(|MA_{\zeta_x}|, |\Phi_j|)}}
			\end{equation}
			\vspace{-2em}
		\end{center}      
    \vfill
...
\begin{frame}{Stitching}{Example -- Two Segment Images}
  ...
  \begin{center}
	  \begin{tabular}{>{\centering\arraybackslash}b{0.2\textwidth} >{\centering\arraybackslash}b{0.70\textwidth} }
		    ...
		    \fbox{\includegraphics[scale=0.23]{./images/stitching/stitching_image_segment_1.jpg}} 
		    & \fbox{\includegraphics[scale=0.23]{./images/stitching/stitching_image_segment_2.jpg}}
		    \\~\\
...
\begin{frame}{Stitching}{Example -- Stitching Piece Locations}
  ...
  \begin{center}
	  \begin{tabular}{>{\centering\arraybackslash}b{0.2\textwidth} >{\centering\arraybackslash}b{0.70\textwidth} }
		    ...
		    \fbox{\includegraphics[scale=0.23]{./images/stitching/stitching_pieces_segment_1.jpg}} 
		    & \fbox{\includegraphics[scale=0.23]{./images/stitching/stitching_pieces_segment_2.jpg}}
		    \\~\\
		    \textbf{Segment \#1} & \textbf{Segment \#2}
	  \end{tabular}
	\end{center}
...
\begin{frame}{Stitching}{Example -- Stitching Piece Locations}
  ...
  \begin{center}
	  \begin{tabular}{>{\centering\arraybackslash}m{0.8\textwidth} }
		    ...
		    \fbox{\includegraphics[scale=0.23]{./images/stitching/segment_1_stitching.jpg}} 
		    \\~\\
...
\begin{frame}{Hierarchical Segment Clustering}{Calculating the Initial Similarity Matrix}
  \begin{itemize}
    ...
    \vspace{1em}
    \item \textbf{Hierarchical Clustering Similarity Matrix}: A triangular matrix quantifying the similarity between segment pairs.
    \vspace{1em}
    ...
    {\setlength\fboxrule{1.25pt}
		  ...
		  \setlength{\tabcolsep}{0pt}
			  \begin{tabular}{>{\centering\arraybackslash}b{0.45\textwidth}>{\centering\arraybackslash}b{0.20\textwidth}>{\centering\arraybackslash}b{0.185\textwidth}}
		        \cfbox{spartanBlue}{\includegraphics[scale=0.25]{./images/clustering/mcgill_20_segment_1.jpg}
				    \hspace{0.025in} \includegraphics[scale=0.25]{./images/clustering/mcgill_20_segment_2.jpg}}
				    & \includegraphics[scale=0.25]{./images/clustering/mcgill_20_segment_3.jpg}
				    & \includegraphics[scale=0.25]{./images/clustering/mcgill_20_segment_4.jpg}
				    \\~\\
    ...
    {\setlength\fboxrule{1.25pt}
		  ...
		  \setlength{\tabcolsep}{0pt}
			  \begin{tabular}{>{\centering\arraybackslash}b{0.45\textwidth} >{\centering\arraybackslash}b{0.45\textwidth}}
				   \cfbox{spartanBlue}{\includegraphics[scale=0.25]{./images/clustering/mcgill_20_segment_1.jpg}
				    \hspace{0.025in} \includegraphics[scale=0.25]{./images/clustering/mcgill_20_segment_2.jpg}}
				    & \cfbox{spartanYellow}{\includegraphics[scale=0.25]{./images/clustering/mcgill_20_segment_3.jpg}
				    \hspace{0.025in} \includegraphics[scale=0.25]{./images/clustering/mcgill_20_segment_4.jpg}}
				    \\~\\
  ...
  \begin{figure}
    ...
    \begin{tabular}{ 
      >{\centering\arraybackslash}m{0.44\textwidth} >{\centering\arraybackslash}m{0.44\textwidth} }
	    \onslide<1->{
	      \fbox{\includegraphics[width=0.40\textwidth]{./images/muffins_300x200_type1.jpg}}
	    } &
	    \only<2>{\fbox{\includegraphics[width=0.40\textwidth]{./images/muffins_300x200_type1_EDAS.jpg}}}\only<3>{\fbox{\includegraphics[width=0.40\textwidth]{./images/muffins_300x200_type1_SEDAS.jpg}}}
	    \\ ~\\
	    \onslide<1->{
...
\begin{frame}{Determining Input Puzzle Count}{Visual Comparison of a Misclassified Image}
  \begin{tabular}{ >{\centering\arraybackslash}m{0.44\textwidth} >{\centering\arraybackslash}m{0.44\textwidth} }
	  \fbox{\includegraphics[width=0.415\textwidth]{./images/single_puzzle/pomeranz_805_14.jpg}}
	  &
	  \fbox{\includegraphics[width=0.415\textwidth]{./images/single_puzzle/pomeranz_805_12.jpg}}  
	  \\~\\	
       ...
       \begin{scaletikzpicturetowidth}{0.9\textwidth}
        \begin{tikzpicture}[scale=\tikzscale]
          \begin{axis}[
            height=8cm, width=12cm,
            axis background/.style={fill=gray!10},
            title=\textbf{Effect of the Number of Input Puzzles on Perfect Reconstruction},
            xlabel={\textbf{Number of Input Puzzles}},
...
{\small
	\begin{figure}[t]
	  ...
	  \begin{tabular}{ >{\centering\arraybackslash}m{0.40\textwidth} >{\centering\arraybackslash}m{0.40\textwidth} }
	     \onslide<1->{\fbox{\includegraphics[width=0.37\textwidth]{./images/dessert_pixabay.jpg}}}  
	     & \onslide<2->{\fbox{\includegraphics[width=0.37\textwidth]{./images/dessert_best_buddy_visualization.jpg}}}
	     \\~\\
