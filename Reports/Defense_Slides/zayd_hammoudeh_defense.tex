  ...
  \begin{figure}
    ...
    \begin{tabular}{ 
      >{\centering\arraybackslash}m{0.44\textwidth} >{\centering\arraybackslash}m{0.47\textwidth} }
	    ...
	    \only<2>{\fbox{\includegraphics[width=0.44\textwidth]{./images/muffins_300x200_type1_EDAS.jpg}}}\only<3>{\fbox{\includegraphics[width=0.42\textwidth]{./images/muffins_300x200_type1_SEDAS.jpg}}}
	    \\ ~\\
	    \onslide<1->{
	      {\small Solver Output}
	    } & 
