...
\begin{split}
\begin{matrix}
\forall{x_k \in \{Pieces\}}\forall{s_c} & C(x_i, s_a, x_j, s_b) \geq C(x_i, s_a, x_k, s_c)
\\
\\
\multicolumn{2}{c}{\textnormal{and}}
\\
\\
\forall{x_k \in \{Pieces\}}\forall{s_c} & C(x_j, s_b, x_i, s_a) \geq C(x_j, s_b, x_k, s_c)
\end{matrix}
\end{split}
\end{equation}
