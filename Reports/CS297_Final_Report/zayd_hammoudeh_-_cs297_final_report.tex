...
\usepackage{xcolor, colortbl} % Used for coloring the cells of the table
\usepackage{amsmath}
...
This section describes in detail the solver proposed by Paikin \& Tal.  The official source code for this solver was never made open source.  As part of this thesis, Paikin \& Tal solver was implemented in Python.  The following subsection describes the components of the Paikin \& Tal solver and is followed by a discussion concerning some of the solver's weaknesses.
