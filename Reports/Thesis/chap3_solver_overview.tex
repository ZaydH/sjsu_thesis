...
As mentioned previously, pieces from a single ground-truth image may be separated into multiple segments.  Hence, the Mixed-Bag Solver must be able to determine any potential affinity between the disjoint segments found during the segmentation stage.  