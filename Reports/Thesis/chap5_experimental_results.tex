...
\\~\\
  ...
  \end{tabular}
\caption{Comparison of Best Buddy Density and Interior Non-Adjacent Best Buddies for Two Images from the Pomeranz~\textit{et al.}~805~Piece Data Set.  Images (a) and (b) Reproduced with Permission from Pomeranz \textit{et. al.}}
