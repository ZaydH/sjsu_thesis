...
\begin{table}[tb]
  \begin{center}
    \caption{Number of Solver Iterations for Each Puzzle Input Count}
    ...
    \end{tabular}
  \end{center}
  \label{tab:numberSolverIterations}
\end{table}
...
\centering
  \begin{tabular}{ >{\centering\arraybackslash}m{0.47\textwidth} >{\centering\arraybackslash}m{0.47\textwidth} }
	...
	Ground-Truth Image~(a)~\cite{pomeranzBenchmarkImages} & Best Buddy Visualization of Image~(a) 
\\~\\
	...
	Ground-Truth Image~(b)~\cite{pomeranzBenchmarkImages} & Best Buddy Visualization of Image~(b) 
  \end{tabular}
...
\begin{table}[tb]
\begin{center}
\caption{Comparison of the Mixed-Bag and Paikin~\& Tal Solvers' Performance on Multiple Input Puzzles}
...
\end{tabular}
\end{center}
\label{tab:tableSolverPerformanceComparison}
\end{table}
...
\begin{table}[tb]
\begin{center}
\caption{Comparison of the Image Shifting, SEDAS, and ENAS Results for the 10 Puzzle Data Set}
...
\end{tabular}
\end{center}
\label{tab:pomeranzBestBuddiesVisualizations}
\end{table}