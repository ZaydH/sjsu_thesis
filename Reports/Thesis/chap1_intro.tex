...
This thesis describes a fully-automated solver for the simultaneous assembly of multiple jigsaw puzzles.  Unlike previous solvers, the algorithm presented here does not require any information beyond the set of puzzle pieces.  What is more, this thesis defines a set of new metrics specifically tailored for quantifying the quality of outputs of multiple puzzle solvers.  Lastly, this thesis outlines a set of standards for visualizing the characteristics of solver outputs.