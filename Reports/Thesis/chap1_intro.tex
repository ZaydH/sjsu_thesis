...
This thesis describes a fully-automated solver for the simultaneous assembly of multiple jigsaw puzzles.  Unlike previous solvers, this algorithm presented here does not require any human input concerning the attributes of the input set of pieces (e.g., the the number of ground-truth puzzles).  What is more, this thesis defines a set of new metrics specifically tailored to quantify the quality of outputs of multiple puzzle solvers.  Lastly, this thesis outlines a set of standards for visualizing the accuracy and quality of solver outputs.