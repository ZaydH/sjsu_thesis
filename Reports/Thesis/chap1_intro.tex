...
Chapter~\ref{chap:mixedBagSolver} describes a fully-automated solver for the simultaneous assembly of multiple jigsaw puzzles; this algorithm does not require any information beyond the set of puzzle pieces.  What is more, this thesis defines a set of new metrics specifically tailored for quantifying the quality of outputs of multiple puzzle solvers. Chapter~\ref{chap:quantifyingSolverQuantify} outlines a set of standards for visualizing the characteristics of solver outputs.  Lastly, Chapter~\ref{chap:experimentalResults} compares the performance of this thesis' solver to the current state of the art.