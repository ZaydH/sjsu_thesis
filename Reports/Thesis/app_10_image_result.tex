...
\centering
  \begin{tabular}{ >{\centering\arraybackslash}m{0.45\textwidth} >{\centering\arraybackslash}m{0.45\textwidth} }
	...
	\fbox{\includegraphics[scale=0.2]{./images/10_puzzles/reconstructed_primula_pixabay.jpg}} & \fbox{\includegraphics[scale=0.2]{./images/10_puzzles/reconstructed_dandelion_pixabay.jpg}} \\~\\
	Reconstructed Image (a) & Reconstructed Image (b)
\\~\\
	\fbox{\includegraphics[scale=0.2]{./images/10_puzzles/reconstructed_cho_432_18.jpg}} & \fbox{\includegraphics[scale=0.2]{./images/10_puzzles/reconstructed_mcgill_540_16.jpg}} \\~\\
	Reconstructed Image (c) & Reconstructed Image (d) 
\\~\\
	\fbox{\includegraphics[scale=0.2]{./images/10_puzzles/reconstructed_mcgill_540_15.jpg}} & \fbox{\includegraphics[scale=0.2]{./images/10_puzzles/reconstructed_mcgill_540_7.jpg}}
\\~\\
...
\centering
  \begin{tabular}{ >{\centering\arraybackslash}m{0.5\textwidth} >{\centering\arraybackslash}m{0.5\textwidth} }
	...
	\fbox{\includegraphics[scale=0.2]{./images/10_puzzles/reconstructed_pomeranz_805_8.jpg}} & \fbox{\includegraphics[scale=0.2]{./images/10_puzzles/reconstructed_pomeranz_805_13.jpg}} \\~\\
	Reconstructed Image (g) & Reconstructed Image (h) 
\\~\\
	\fbox{\includegraphics[scale=0.2]{./images/10_puzzles/reconstructed_pomeranz_805_14.jpg}} & \fbox{\includegraphics[scale=0.2]{./images/10_puzzles/reconstructed_pomeranz_805_19.jpg}}
\\~\\
...
\centering
  \begin{tabular}{ >{\centering\arraybackslash}m{0.45\textwidth} >{\centering\arraybackslash}m{0.45\textwidth} }
	...
	\fbox{\includegraphics[scale=0.2]{./images/10_puzzles/sedas_primula_pixabay.jpg}} & \fbox{\includegraphics[scale=0.2]{./images/10_puzzles/sedas_dandelion_pixabay.jpg}} \\~\\
	SEDAS Visualization of Image (a) & SEDAS Visualization of Image (b)
\\~\\
	\fbox{\includegraphics[scale=0.2]{./images/10_puzzles/sedas_cho_432_18.png}} & \fbox{\includegraphics[scale=0.2]{./images/10_puzzles/sedas_mcgill_540_16.jpg}} \\~\\
	SEDAS Visualization of Image (c) & SEDAS Visualization of Image (d) 
\\~\\
	\fbox{\includegraphics[scale=0.2]{./images/10_puzzles/sedas_mcgill_540_15.jpg}} & \fbox{\includegraphics[scale=0.2]{./images/10_puzzles/sedas_mcgill_540_7.jpg}}
\\~\\
...
\centering
  \begin{tabular}{ >{\centering\arraybackslash}m{0.5\textwidth} >{\centering\arraybackslash}m{0.5\textwidth} }
	...
	\fbox{\includegraphics[scale=0.2]{./images/10_puzzles/sedas_pomeranz_805_8.jpg}} & \fbox{\includegraphics[scale=0.2]{./images/10_puzzles/sedas_pomeranz_805_13.jpg}} \\~\\
	SEDAS Visualization of Image (g) & SEDAS Visualization of Image (h) 
\\~\\
	\fbox{\includegraphics[scale=0.2]{./images/10_puzzles/sedas_pomeranz_805_14.jpg}} & \fbox{\includegraphics[scale=0.2]{./images/10_puzzles/sedas_pomeranz_805_19.jpg}}
\\~\\
