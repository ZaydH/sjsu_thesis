...
Best buddy density may vary across an image with some areas showing lower density than others. Equation~\eref{eq:bestBuddyDensity} can be adjusted to a more localized metric by considering only a subset of the connected pieces.
