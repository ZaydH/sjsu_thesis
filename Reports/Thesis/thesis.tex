...
% ***** title
%
\title{A Fully-Automated Solver for Multiple Jigsaw Puzzles Using Hierarchical Clustering}
...
%
\newappendix{appendix_segmenter_example}
\newappendix{appendix_single_puzzle_incorrect_puzzle_count}
\newappendix{appendix_10_image_result}
