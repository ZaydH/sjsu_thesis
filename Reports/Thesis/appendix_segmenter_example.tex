...
\centering
  ...
  \end{tabular}
\caption{Segmentation of the Assembler Output with Marking of the Articulation Points and the Lightness of Piece Coloring Dependent on Distance to the Nearest Open Location}
