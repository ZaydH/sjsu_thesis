...
class PuzzlePiece:
    ...
    def _get_unrotated_coordinates(self, rotated_x, rotated_y):
        ...
        numb_90_degree_rotations = (PuzzlePiece.Rotation._degree_360 - self._rotation) % PuzzlePiece.Rotation._degree_360
        numb_90_degree_rotations /= PuzzlePiece.Rotation._degree_90
        for i in range(0, numb_90_degree_rotations):
            (unrotated_x, unrotated_y) = self._get_rotated_coordinates(rotated_x, rotated_y)
    ...
    def _get_rotated_coordinates(self, unrotated_x, unrotated_y):
        """
    ...
    def set_rotation(self, rotation):
        ...
        :param rotation: Type Rotation.  The rotation of this
                         puzzle piece.
        """
        if(rotation % self.Rotation.degree_90 != 0):
